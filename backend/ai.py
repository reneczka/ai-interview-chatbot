...
def request_AI(interview_history: List[Dict[str, str]], model: str = "gpt-4o-mini", max_tokens: int = 500) -> str:
    payload = {
...
def generate_first_question(interview_history: List[Dict[str, str]]) -> str:
    return request_AI(interview_history)

def generate_evaluation_and_next_question(interview_history: List[Dict[str, str]]) -> str:
    return request_AI(interview_history)

def generate_final_evaluation(interview_history: List[Dict[str, str]]) -> str:
